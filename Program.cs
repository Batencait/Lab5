...
namespace Lab5
{
    public partial class Form1 : Form
    {
        ...
        static double Long(double x1, double x2, double y1, double y2)
        {
            double ABx = y2 - y1;
            double ABy = x2 - x1;
        ...
        static double Chosing(double A, double B, double C, double D)
        {
        ...
        static double Per(double A, double B, double C, double D)
        {
            double Per = A + B + C + D;
            label11.Text = $"Периметр фигуры = {Per}");
            return Per;
        }
        ...
        {
            double Sq = A * B;
            label14.Text = $"Площадь фигуры = {Sq}";
            return Sq;
        }

        static double ChosingSecond(double A, double B, double C, double D)
        {
